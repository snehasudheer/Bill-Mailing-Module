  ...
  if(isset($_POST['sub_bt']))
	{
		...
		elseif($row['LASTDATE']>$cur_date)
		{
		 header('Location:bill_pay.php?cno='.$consumerno.'&bill_no='.$bill_no.'&bill_type='.$bill_type.'&msg=expired');
		}
		}
		else
		{
...
<!-- Start Page Banner -->
  ...
  <div class="container" style="margin-top:2%;">
	 ...
	 <div class="form-group">
		...
		<input class="form-control" type="text" name="con_no" id="con_no" value="<?php echo $row['CNO']; ?>" >
		</div>
		<div class="signleftbox">Bill No: </div>
		<div class="signrightbox">
			<input class="form-control" type="text" name="bill_no" id="bill_no" value="<?php echo $row['BILLNO']; ?>" >
		</div>
		<div class="signleftbox">Bill Date: </div>
		<div class="signrightbox">
			<input class="form-control" type="text" name="bill_dt" id="bill_dt" value="<?php echo $row['BILLDATE']; ?>" >
		</div>
		<div class="signleftbox">Disconnection Date: </div>
		<div class="signrightbox">
			<input class="form-control" type="text" name="dis_dt" id="dis_dt" value="<?php echo $row['DISDATE']; ?>" >
		</div>
		<div class="signleftbox">Amount: </div>
		<div class="signrightbox">
		<input class="form-control" type="text" name="amnt" id="amnt" value="<?php echo $row['TOTAL']; ?>">
		</div>
