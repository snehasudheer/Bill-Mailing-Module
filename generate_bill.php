...
$pdf->AddPage();
			...
			//exit;
				...
				$pdf->lastPage();
				$pdf->Output(dirname(__FILE__).'/HT_bill/ht_bill_'.$row['BILL_NO'].'_'.$row['BILL_DATE'].'.pdf', 'F');
				$stid3 = oci_parse($conn, "insert into send_bill values('".$bill_type."','".$row['BILL_NO']."','1','0','0')");
					oci_execute($stid3);
				}
				echo "1";
			}
